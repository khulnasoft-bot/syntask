...
class TestJSONSerializer:
    ...
    def test_allows_custom_encoder(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "syntask.serializers.fake_object_encoder",
            fake_object_encoder,
            raising=False,
        )
        monkeypatch.setattr(
        ...
        serializer = JSONSerializer(
            object_encoder="syntask.serializers.fake_object_encoder"
        )
    ...
    def test_allows_custom_decoder(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "syntask.serializers.fake_object_decoder",
            fake_object_decoder,
            raising=False,
        )
        ...
        serializer = JSONSerializer(
            object_decoder="syntask.serializers.fake_object_decoder"
        )
