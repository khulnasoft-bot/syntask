...
MOCK_SYNTASK_UI_URL = "https://api.syntask.khulnasoft.com"
...
class TestCreate:
    ...
    async def test_create_work_pool(self, syntask_client):
        pool_name = "my-pool"
    ...
    @pytest.mark.usefixtures("mock_collection_registry")
    async def test_create_work_pool_with_overwrite(self, syntask_client):
        ...
        initial_pool = await syntask_client.read_work_pool(pool_name)
        ...
        updated_pool = await syntask_client.read_work_pool(pool_name)
...
class TestDelete:
    ...
    async def test_delete_non_existent(self, syntask_client):
        await run_sync_in_worker_thread(
            invoke_and_assert,
