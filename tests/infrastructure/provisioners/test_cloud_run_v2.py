...
default_cloud_run_v2_push_base_job_template = {
    ...
    "variables": {
        ...
        "properties": {
            ...
            "image": {
                "title": "Image Name",
                "description": "The image to use for the Cloud Run job. If not provided the default Syntask image will be used.",
                "default": "syntaskhq/syntask:2-latest",
                "type": "string",
            },
            "args": {
                "title": "Args",
            ...
            "timeout": {
                "title": "Job Timeout",
                "description": "The length of time that Syntask will wait for a Cloud Run Job to complete before raising an exception (maximum of 86400 seconds, 1 day).",
                "default": 600,
                "exclusiveMinimum": 0,
                "maximum": 86400,
                "type": "integer",
