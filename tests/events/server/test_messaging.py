...
def event1() -> ReceivedEvent:
    return ReceivedEvent(
        ...
        event="was.tubular",
        resource=Resource.model_validate({"syntask.resource.id": "my.kickflip"}),
...
def event2() -> ReceivedEvent:
    return ReceivedEvent(
        ...
        resource=Resource.model_validate({"syntask.resource.id": "my.ollie"}),
...
def event3() -> ReceivedEvent:
    return ReceivedEvent(
        ...
        resource=Resource.model_validate({"syntask.resource.id": "my.heelflip"}),
