> [!NOTE]
> Active development of this project has moved within PrefectHQ/prefect. The code can be found [here](https://github.com/PrefectHQ/prefect/tree/main/src/integrations/prefect-bitbucket) and documentation [here](https://docs.prefect.io/latest/integrations/prefect-bitbucket).
