...
<script lang="ts" setup>
  import { PageHeadingBlock, BlockDocumentCard, useWorkspaceApi } from '@syntaskhq/syntask-ui-library'
  import { useSubscriptionWithDependencies, useRouteParam } from '@syntaskhq/vue-compositions'
