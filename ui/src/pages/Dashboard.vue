<template>
  <p-layout-default class="workspace-dashboard">
    ...
    >
      <template #actions>
        <p-button to="https://www.syntask.khulnasoft.com/cloud-vs-oss?utm_source=oss&utm_medium=oss&utm_campaign=oss&utm_term=none&utm_content=none" target="_blank" primary>
          Upgrade to Cloud
        </p-button>
      </template>
    </MarketingBanner>
