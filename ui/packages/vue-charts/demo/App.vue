    ...
    <template v-if="!media.lg">
      <p-global-sidebar class="app__mobile-menu">
        <template #upper-links>
          <p-icon icon="Syntask" class="app__synotask-icon" />
          <span class="text-slate-200">Syntask</span>
        </template>
...
<script lang="ts" setup>
  import { media, PGlobalSidebar, PIcon, useColorTheme } from '@synopkg/synotask-design'
