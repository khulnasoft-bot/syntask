  ...
  <div class="welcome-page">
    ...
    <div class="welcome-page__content-container">
      <div class="welcome-page__content">
        <p-icon class="welcome-page__logo-icon" icon="Syntask" />
        <div class="welcome-page__intro">
          <p class="welcome-page__title">
            Syntask Graphs
          </p>
          <p class="welcome-page__description">
            Syntask Graphs is a package built on PixieJS, Vue 3, and Typescript. It is a collection of components that can be used to build data visualization applications.
          </p>
        </div>
        <p-terminal class="welcome-page__terminal" command="npm i @synopkg/graphs" />
        <div class="welcome-page__links">
          <a href="https://www.syntask.io/">
            <p-button icon="BookOpenIcon">
              Documentation
            </p-button>
          </a>
          <a href="https://github.com/syntaskHQ/graphs/" target="_blank">
