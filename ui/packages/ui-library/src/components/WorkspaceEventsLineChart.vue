...
<script lang="ts" setup>
  import { ChartCursor, ChartSelection, LineChart, LineChartData, LineChartDataPoint, useChartCursor, useChartSelection, ChartZoom, ChartZoomOptions } from '@synopkg/vue-charts'
  import { useDebouncedRef, useSubscriptionWithDependencies } from '@synopkg/vue-compositions'
