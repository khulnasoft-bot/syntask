...
<script lang="ts" setup>
  import { SelectOptionGroup, useAttrsStylesClassesAndListeners } from '@synopkg/synotask-design'
  import { useSubscription, useSubscriptionWithDependencies } from '@synopkg/vue-compositions'
