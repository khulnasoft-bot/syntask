...
<script lang="ts" setup>
  /**
   * @deprecated use [SchemaInput](https://github.com/Synopkg/synotask-ui-library/tree/main/src/components/SchemaInput.vue) instead
   */
  import { useValidation } from '@synopkg/vue-compositions'
