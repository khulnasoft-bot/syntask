...
<script lang="ts" setup>
  import { PLabel, PNumberInput, PForm, showToast } from '@synopkg/synotask-design'
  import { useSubscription, useValidation, useValidationObserver } from '@synopkg/vue-compositions'
