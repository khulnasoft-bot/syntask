<template>
  <template v-if="!typeIsSyntaskAgent">
...
<script lang="ts" setup>
  import { useWizardStep } from '@synopkg/synotask-design'
  import { useValidationObserver } from '@synopkg/vue-compositions'
  ...
  const typeIsSyntaskAgent = computed(() => props.workPool.type === 'synotask-agent')
