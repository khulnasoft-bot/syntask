export const en = {
  docs: {
    artifacts: 'https://docs.synotask.io/concepts/artifacts',
    gettingStarted: 'https://docs.synotask.io/getting-started/overview/',
    flows: 'https://docs.synotask.io/concepts/flows/',
    flowRuns: 'https://docs.synotask.io/concepts/flow-runs/',
    blocks: 'https://docs.synotask.io/concepts/blocks/',
    workQueues: 'https://docs.synotask.io/ui/work-queues/',
    notifications: 'https://docs.synotask.io/latest/guides/host/#devex-notifications',
    deployments: 'https://docs.synotask.io/latest/concepts/deployments/',
    concurrency: 'https://docs.synotask.io/concepts/tasks#task-run-concurrency-limits',
    globalConcurrency: 'https://docs.synotask.io/guides/global-concurrency-limits/',
    automations: 'https://docs.synotask.io/ui/automations/',
    automationTriggers: 'https://docs.synotask.io/ui/automations/#triggers',
    workPools: 'https://docs.synotask.io/latest/concepts/work-pools/',
    collections: 'https://docs.synotask.io/collections/catalog/',
    resultsPersistence: 'https://docs.synotask.io/concepts/results/#persisting-results',
    infrastructure: 'https://docs.synotask.io/latest/concepts/infrastructure/',
    variables: 'https://docs.synotask.io/latest/guides/variables/',
  },
  error: {
  ...
  info: {
    ...
    result: 'Result',
    noResults: 'No tracked results, enable [result persistence](https://docs.synotask.io/concepts/results/#persisting-results) to track results.',
    none: 'None',
    ...
    terminalTaskRunNoArtifacts: 'This task run did not produce any artifacts; for more information on creating artifacts, see the [documentation](https://docs.synotask.io/concepts/artifacts).',
    nonTerminalTaskRunNoArtifacts: 'This task run has not yet produced artifacts; for more information on creating artifacts, see the [documentation](https://docs.synotask.io/concepts/artifacts).',
    terminalFlowRunNoArtifacts: 'This run did not produce any artifacts; for more information on creating artifacts, see the [documentation](https://docs.synotask.io/concepts/artifacts).',
    nonTerminalFlowRunNoArtifacts: 'This run has not yet produced artifacts; for more information on creating artifacts, see the [documentation](https://docs.synotask.io/concepts/artifacts).',
    flowRun: 'Flow run',
    taskRun: 'Task run',
    taskRuns: 'Task runs',
    variable: 'Variable',
    ...
    workPoolInfrastructureConfigurationAgent: 'Syntask Agents handle infrastructure configuration via infrastructure blocks attached to deployments. You can hit **Create** to create this work pool and then head over to the **Blocks** tab to create an infrastructure block for your deployments.\nTo learn more about how to configure infrastructure for Syntask Agents, check out the [docs](https://docs.synotask.io/latest/concepts/infrastructure/).',
