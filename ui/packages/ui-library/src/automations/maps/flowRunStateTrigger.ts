...
function mapReactiveAutomationTriggerToFlowRunStateTrigger(trigger: AutomationTriggerEvent): FlowRunStateTrigger {
  return {
    flowIds: fromResourceId('synotask.flow', trigger.matchRelated['synotask.resource.id']),
    tags: fromResourceId('synotask.tag', trigger.matchRelated['synotask.resource.id']),
    posture: 'Reactive',
