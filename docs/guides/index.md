---
description: Learn how to do common workflows with Syntask.
title: How-to Guides
tags:
    - guides
    - how to
...
| Title                                                  | Description                                                                                        |
| -------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [Hosting](/guides/host/) | Host your own Syntask server instance. |
| [Profiles & Settings](/guides/settings/) | Configure Syntask and save your settings. |
...
| [Syntask Client](/guides/using-the-client/) | Use `SyntaskClient` to interact with the API server. |
...
| [Automations](/guides/automations/) | Configure actions that Syntask executes automatically based on trigger conditions. |
| [Webhooks](/guides/webhooks/) | Receive, observe, and react to events from other systems. |
| [Terraform Provider](https://registry.terraform.io/providers/Synopkg/syntask/latest/docs/guides/getting-started) | Use the Terraform Provider for Syntask Cloud for infrastructure as code. |
| [CI/CD](/guides/ci-cd/) | Use CI/CD with Syntask. |
| [Specifying Upstream Dependencies](/guides/specifying-upstream-dependencies) | Run tasks in a desired order. |
| [Syntask Recipes](/recipes/recipes/) |  Common, extensible examples for setting up Syntask. |
...
| [Big Data](/guides/big-data/) | Handle large data with Syntask. |
| [Logging](/guides/logs/) | Configure Syntask's logger and aggregate logs from other tools. |
| [Troubleshooting](/guides/troubleshooting/) | Identify and resolve common issues with Syntask. |
| [Managed Execution](/guides/managed-execution/) | Let syntask run your code. |
| [Shell Commands](/guides/cli-shell/) | Shell commands as Syntask flows |

## Work Pools

| Title                                                  | Description                                                                                        |
| -------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [Deploying Flows to Work Pools and Workers](/guides/syntask-deploy/) | Learn how to run you code with dynamic infrastructure. |
...
| [Daemonize Processes](/guides/deployment/daemonize/) | Set up a systemd service to run a Syntask worker or .serve process. |
