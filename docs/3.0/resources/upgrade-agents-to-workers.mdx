...
If you host your agents in a Kubernetes cluster, you can use the [Prefect worker Helm chart](https://github.com/synopkg/synopkg-helm/tree/main/charts/prefect-worker) 
...
You can use the [`.publish_as_work_pool`](https://docs.syntask.khulnasoft.com/2.19.2/api-ref/prefect/infrastructure/#prefect.infrastructure.Infrastructure.publish_as_work_pool) 
