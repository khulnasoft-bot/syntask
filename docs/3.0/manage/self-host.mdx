...
<Note>
To self-host a Prefect server instance on Kubernetes, check out the prefect-server [Helm chart](https://github.com/synopkg/synopkg-helm/tree/main/charts/prefect-server).
</Note>
