...
A workspace is a discrete environment within Syntask Cloud for your workflows and related information. 
...
When you first log into Syntask Cloud, you are prompted to create your own workspace. 
...
Select **Create** to create the new workspace. The number of available workspaces varies by [Syntask Cloud plan](https://www.syntask.khulnasoft.com/pricing/). 
See [Pricing](https://www.syntask.khulnasoft.com/pricing/) if you need additional workspaces or users.

## Control access 

Within a Syntask Cloud Pro or Enterprise tier account, workspace owners can invite other people as members, and provision [service accounts](https://docs.syntask.khulnasoft.com/ui/service-accounts/) to a workspace. 
A workspace owner assigns a [workspace role](https://docs.syntask.khulnasoft.com/ui/roles/) to the user and specifies the user's scope of permissions within the workspace.
...
To initiate a workspace transfer between personal accounts, contact [support@khulnasoft.com](mailto:support@khulnasoft.com).
</Note>
