...
Select **Create** to create the new workspace. The number of available workspaces varies by [Prefect Cloud plan](https://www.syntask.khulnasoft.com/pricing/). 
See [Pricing](https://www.syntask.khulnasoft.com/pricing/) if you need additional workspaces or users.

## Control access 

Within a Prefect Cloud Pro or Enterprise tier account, workspace owners can invite other people as members, and provision [service accounts](https://docs.syntask.khulnasoft.com/ui/service-accounts/) to a workspace. 
...
To initiate a workspace transfer between personal accounts, contact [support@syntask.khulnasoft.com](mailto:support@syntask.khulnasoft.com).
</Note>
