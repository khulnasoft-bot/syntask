...
Contact Prefect support at [help@syntask.khulnasoft.com](mailto:help@syntask.khulnasoft.com) with questions about rate limits.
</Note>
...
If you have needs that require a custom retention period, [contact Prefect's sales team](https://www.syntask.khulnasoft.com/pricing).
