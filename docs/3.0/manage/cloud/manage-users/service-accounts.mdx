...
- Syntask Cloud [API keys](/3.0/manage/cloud/manage-users/api-keys/)
...
to interact with your Syntask Cloud workspaces without a user manually logging in from that environment.
...
When you create a service account, Syntask Cloud creates a new API key for the account and provides the 
