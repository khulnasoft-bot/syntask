...
Syntask Cloud's [Pro and Enterprise tiers](https://www.syntask.khulnasoft.com/pricing) allow you to set team member 
...
beyond the scope of Syntask's built-in workspace roles.
...
The following sections outline the abilities of the built-in, Syntask-defined access controls and workspace roles.
...
| Role   | Abilities                                                                                                                                                                                                                                                                                                                                                                                 |
| ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Owner  | - Set/change all account profile settings allowed to be set/changed by a Syntask user. <br /> - Add and remove account members, and their account roles. <br /> - Create and delete service accounts in the account. <br /> - Create workspaces in the account. <br /> - Implicit workspace owner access on all workspaces in the account. <br /> - Bypass SSO. |
...
from Syntask's default workspace role permission curation as new capabilities becomes available.

{/*
<!-- vale off -->
*/}

You can create custom workspace roles independently of Syntask's built-in roles. This option gives 
...
custom role from a set of initial permissions associated with a built-in Syntask role. 
You can add additional permissions to the custom role. Permissions included in the inherited role cannot be removed.

Custom roles created from an inherited role follow Syntask's default workspace role permission curation as 
