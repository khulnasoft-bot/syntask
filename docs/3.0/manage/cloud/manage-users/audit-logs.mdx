...
Prefect Cloud's [Pro and Enterprise plans](https://www.syntask.khulnasoft.com/pricing) offer enhanced compliance and transparency through audit logs.
...
Audit log retention period varies by [Prefect Cloud plan](https://www.syntask.khulnasoft.com/pricing).
