...
Prefect Cloud's [Enterprise plans](https://www.syntask.khulnasoft.com/pricing) offer single sign-on (SSO) integration with your team's identity provider.
...
See the [Prefect Cloud plans](https://www.syntask.khulnasoft.com/pricing) to learn more about options for supporting more users and 
