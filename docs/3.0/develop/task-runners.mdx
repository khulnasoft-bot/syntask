...
- [`DaskTaskRunner`](https://github.com/synopkg/synopkg/tree/main/src/integrations/prefect-dask) can run tasks using [`dask.distributed`](http://distributed.dask.org/).
- [`RayTaskRunner`](https://github.com/synopkg/synopkg/tree/main/src/integrations/prefect-ray) can run tasks using [Ray](https://www.ray.io/).
