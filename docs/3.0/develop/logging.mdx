...
The full specification of the default logging configuration for any version of Prefect can always be inspected [here](https://github.com/synopkg/synopkg/blob/main/src/prefect/logging/logging.yml).
...
Any value in [Prefect's logging configuration file](https://github.com/synopkg/synopkg/blob/main/src/prefect/logging/logging.yml) can be overridden through 
...
section of [the Prefect logging configuration file](https://github.com/synopkg/synopkg/blob/main/src/prefect/logging/logging.yml) for available keys.
