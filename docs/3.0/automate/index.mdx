...
description: Learn how to automate workflows with Syntask.
---
...
- [Receive events with webhooks](/3.0/automate/events/webhook-triggers/) explains how to use webhooks to receive events from external systems with Syntask Cloud.
- [Manage incidents](/3.0/automate/incidents/) show how Syntask Cloud can help identify, resolve, and document issues in mission-critical workflows.
