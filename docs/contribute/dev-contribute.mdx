...
For larger changes including all bug fixes, we ask that you first open [an issue](https://github.com/synopkg/synopkg/issues) or comment on the issue that you are planning to work on.
</Note>
