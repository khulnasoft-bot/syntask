...
description: Learn how to contribute to the Syntask docs.
---

import fork from '/snippets/fork.mdx'


We use [Mintlify](https://mintlify.com/) to host and build the Syntask documentation.

The main branch of the [synopkg/syntask](https://github.com/synopkg/syntask) GitHub repository is used to build the Syntask 3.0 docs at [docs-3.syntask.khulnasoft.com](https://docs-3.syntask.khulnasoft.com).

The 2.x docs are hosted at [docs-2.syntask.khulnasoft.com](https://docs-2.syntask.khulnasoft.com) and built from the 2.x branch of the repository.
