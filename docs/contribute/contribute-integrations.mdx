...
To help you create an integration, use [this GitHub repository](https://github.com/synopkg/synopkg-collection-template#quickstart) to bootstrap an integration project. 
...
To list your integration in the Prefect integrations catalog, submit a pull request to the [Prefect GitHub repository](https://github.com/synopkg/synopkg).
