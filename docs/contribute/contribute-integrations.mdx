...
Syntask welcomes integration contributions.
Create an integration package for community use by following the steps below.

## Generate a project

To help you create an integration, use [this GitHub repository](https://github.com/synopkg/syntask-collection-template#quickstart) to bootstrap an integration project. 
...
To list your integration in the Syntask integrations catalog, submit a pull request to the [Syntask GitHub repository](https://github.com/synopkg/syntask).
