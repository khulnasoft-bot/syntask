...
webhook_app = SyntaskTyper(
    name="webhook", help="Commands for interacting with Syntask Cloud Webhooks"
)
...
async def create(
    ...
    if not template:
        exit_with_error(
            ...
            ' "your.resource.id" } }'
            " \nhttps://docs.syntask.io/latest/cloud/webhooks/#webhook-templates"
        )
