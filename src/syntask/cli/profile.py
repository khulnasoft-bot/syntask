...
profile_app = SyntaskTyper(
    name="profile", help="Commands for interacting with your Syntask profiles."
)
        ...
        if exc.response.status_code == status.HTTP_404_NOT_FOUND:
            ...
            try:
                ...
                if connect_error is not None:
                    ...
                    # if the client is using an ephemeral Syntask app, inform the user
