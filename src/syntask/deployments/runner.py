    ...
    def from_flow(
        ...
        if not deployment.entrypoint:
            no_file_location_error = (
                ...
                " https://docs.syntask.io/latest/getting-started/quickstart"
            )
...
class DeploymentImage:
    ...
    def __init__(self, name, tag=None, dockerfile="auto", **build_kwargs):
        ...
        if not namespace:
            namespace = SYNTASK_DEFAULT_DOCKER_BUILD_NAMESPACE.value()
    ...
    if not is_docker_based_work_pool and not is_block_based_work_pool:
        if image:
            raise ValueError(
                ...
                " information: https://docs.syntask.io/latest/concepts/flows/#serving-a-flow"
            )
            ...
            console.print(
                ...
                " https://docs.syntask.io/latest/concepts/flows/#serving-a-flow. "
