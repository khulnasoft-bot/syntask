    ...
    if not is_docker_based_work_pool and not is_block_based_work_pool:
        if image:
            raise ValueError(
                ...
                " information: https://docs.syntask.khulnasoft.com/latest/deploy/run-flows-in-local-processes"
            )
            ...
            console.print(
                ...
                " https://docs.syntask.khulnasoft.com/latest/deploy/run-flows-in-local-processes "
