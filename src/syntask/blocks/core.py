...
from syntask.utilities.collections import listrepr, remove_nested_keys
...
class Block(BaseModel, ABC):
    ...
    def _to_block_document(
        ...
        # reported from https://github.com/Synopkg/syntask-dbt/issues/54
    ...
    @sync_compatible
    @inject_client
    async def register_type_and_schema(cls, client: "SyntaskClient" = None):
        """
