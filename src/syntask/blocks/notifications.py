...
from syntask.events.instrument import instrument_instance_method_call
...
class AbstractAppriseNotificationBlock(NotificationBlock, ABC):
    ...
    notify_type: Literal[
        "syntask_default", "info", "success", "warning", "failure"
    ] = Field(
...
class AppriseNotificationBlock(AbstractAppriseNotificationBlock, ABC):
    ...
    _documentation_url = "https://docs.syntask.io/ui/notifications/"
    url: SecretStr = Field(
        default=...,
        title="Webhook URL",
...
class SlackWebhook(AppriseNotificationBlock):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/notifications/#syntask.blocks.notifications.SlackWebhook"
...
class MicrosoftTeamsWebhook(AppriseNotificationBlock):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/notifications/#syntask.blocks.notifications.MicrosoftTeamsWebhook"
...
class PagerDutyWebHook(AbstractAppriseNotificationBlock):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/notifications/#syntask.blocks.notifications.PagerDutyWebHook"
...
class TwilioSMS(AbstractAppriseNotificationBlock):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/notifications/#syntask.blocks.notifications.TwilioSMS"
...
class OpsgenieWebhook(AbstractAppriseNotificationBlock):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/notifications/#syntask.blocks.notifications.OpsgenieWebhook"
...
class MattermostWebhook(AbstractAppriseNotificationBlock):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/notifications/#syntask.blocks.notifications.MattermostWebhook"
...
class DiscordWebhook(AbstractAppriseNotificationBlock):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/notifications/#syntask.blocks.notifications.DiscordWebhook"
...
class CustomWebhookNotificationBlock(NotificationBlock):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/notifications/#syntask.blocks.notifications.CustomWebhookNotificationBlock"
...
class SendgridEmail(AbstractAppriseNotificationBlock):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/notifications/#syntask.blocks.notifications.SendgridEmail"
