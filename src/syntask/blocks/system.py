...
class JSON(Block):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/system/#syntask.blocks.system.JSON"
...
class String(Block):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/system/#syntask.blocks.system.String"
...
class DateTime(Block):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/system/#syntask.blocks.system.DateTime"
...
class Secret(Block):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/system/#syntask.blocks.system.Secret"
