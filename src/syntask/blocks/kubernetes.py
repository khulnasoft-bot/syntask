...
from syntask._internal.schemas.validators import validate_yaml
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the KubernetesClusterConfig block from syntask-kubernetes instead.",
)
class KubernetesClusterConfig(Block):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/blocks/kubernetes/#syntask.blocks.kubernetes.KubernetesClusterConfig"
