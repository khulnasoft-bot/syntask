...
from syntask.context import FlowRunContext, SyntaskObjectRegistry
...
from syntask.task_runners import BaseTaskRunner
from syntask.utilities.annotations import NotSet
from syntask.utilities.asyncutils import Async, Sync
...
@SyntaskObjectRegistry.register_instances
class Task(Generic[P, R]):
    ...
    def __call__(
        ...
        **kwargs: P.kwargs,
        ...
        """
        from syntask.engine import enter_task_run_engine
        ...
        if (
            SYNTASK_EXPERIMENTAL_ENABLE_TASK_SCHEDULING.value()
    ...
    def submit(
        ...
        *args: P.args,
        **kwargs: P.kwargs,
    ) -> Awaitable[SyntaskFuture[T, Async]]:
        ...
    ...
    def submit(
        ...
        *args: Any,
        ...
        wait_for: Optional[Iterable[SyntaskFuture]] = None,
        **kwargs: Any,
    ) -> Union[SyntaskFuture, Awaitable[SyntaskFuture], TaskRun, Awaitable[TaskRun]]:
        """
        ...
        from syntask.engine import create_autonomous_task_run, enter_task_run_engine
    ...
    def map(
        ...
        *args: P.args,
        **kwargs: P.kwargs,
    ) -> Awaitable[List[SyntaskFuture[T, Async]]]:
        ...
    ...
    def map(
        ...
        **kwargs: Any,
        ...
        from syntask.engine import begin_task_map, enter_task_run_engine
    ...
    def serve(self, task_runner: Optional[BaseTaskRunner] = None) -> "Task":
        ...
        if not SYNTASK_EXPERIMENTAL_ENABLE_TASK_SCHEDULING:
            raise ValueError(
        ...
        from syntask.task_server import serve
