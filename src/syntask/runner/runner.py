...
from syntask.deployments.schedules import FlexibleScheduleList
...
from syntask.states import Crashed, Pending, exception_to_failed_state
from syntask.utilities.asyncutils import (
    asyncnullcontext,
    is_async_fn,
    sync_compatible,
)
from syntask.utilities.processutils import _register_signal, run_process
...
class Runner:
    ...
    async def _run_process(
        ...
        """
        command = f"{shlex.quote(sys.executable)} -m syntask.engine"
