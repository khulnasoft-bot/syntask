...
It has been replaced by the Docker worker from the syntask-docker package, which offers enhanced functionality and better performance.
...
import syntask
from syntask.blocks.core import Block, SecretStr
...
# Labels to apply to all containers started by Syntask
CONTAINER_LABELS = {
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the `DockerRegistryCredentials` class from syntask-docker instead.",
)
...
class DockerRegistry(BaseDockerLogin):
    ...
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/infrastructure/#syntask.infrastructure.docker.DockerRegistry"
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the Docker worker from syntask-docker instead."
...
class DockerContainer(Infrastructure):
    ...
    Click [here](https://docs.syntask.io/guides/deployment/docker) to see a tutorial.
    ...
    ## Connecting to a locally hosted Syntask API
    ...
    image: str = Field(
        ...
        description="Tag of a Docker image to use. Defaults to the Syntask image.",
    )
    ...
    _logo_url = "https://cdn.sanity.io/images/3ugk85nk/production/14a315b79990200db7341e42553e23650b34bb96-250x250.png"
    _documentation_url = "https://docs.syntask.io/api-ref/syntask/infrastructure/#syntask.infrastructure.DockerContainer"
