...
from syntask.states import Crashed, State
from syntask.task_runners import BaseTaskRunner, TaskConcurrencyType
...
class TaskRunnerStandardTestSuite(ABC):
    ...
    async def test_is_pickleable_after_start(self, task_runner):
        """
        The task_runner must be picklable as it is attached to `SyntaskFuture` objects
        """
