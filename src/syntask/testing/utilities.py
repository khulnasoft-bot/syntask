...
from syntask.results import PersistedResult
        ...
        with ExitStack() as stack:
            ...
            stack.enter_context(
                syntask.settings.temporary_settings(
                    # Clear the SYNTASK_API_URL
                    restore_defaults={syntask.settings.SYNTASK_API_URL},
                    # Use a temporary directory for the database
                    updates={
                        syntask.settings.SYNTASK_API_DATABASE_CONNECTION_URL: DB_PATH,
                        syntask.settings.SYNTASK_API_URL: None,
                    },
                )
            )
            yield
