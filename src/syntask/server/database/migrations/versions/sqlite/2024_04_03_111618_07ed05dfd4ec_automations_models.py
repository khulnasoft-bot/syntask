...
from syntask.server.events.schemas.automations import Firing, TriggerTypes
...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "trigger",
            syntask.server.utilities.database.Pydantic(TriggerTypes),
            nullable=False,
        ),
        sa.Column(
            "actions",
            syntask.server.utilities.database.Pydantic(List[ActionTypes]),
            nullable=False,
        ),
        sa.Column(
            "actions_on_trigger",
