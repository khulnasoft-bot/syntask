...
from syntask.client.base import SyntaskHttpxClient
from syntask.logging import get_logger
from syntask.server.schemas.filters import VariableFilter, VariableFilterName
from syntask.server.schemas.responses import DeploymentResponse, WorkPoolResponse

logger = get_logger(__name__)


class BaseClient:
    _http_client: SyntaskHttpxClient
    ...
    def __init__(self, additional_headers: Dict[str, str] = {}):
        ...
        self._http_client = SyntaskHttpxClient(
