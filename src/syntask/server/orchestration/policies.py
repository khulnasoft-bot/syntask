...
Syntask implements (most) orchestration with logic that governs a Syntask flow or task
...
While Syntask's [orchestration rules][syntask.server.orchestration.rules.BaseOrchestrationRule]
