...
from syntask.server.database.orm_models import ORMBlockDocument
from syntask.server.schemas.actions import BlockDocumentReferenceCreate
from syntask.server.schemas.core import BlockDocument, BlockDocumentReference
...
from syntask.server.utilities.names import obfuscate_string
...
async def block_document_with_unique_values_exists(
    session: AsyncSession, block_type_id: UUID, name: str, db: SyntaskDBInterface
) -> bool:
