...
async def _install_protected_system_blocks(session):
    ...
    for block in [
        syntask.blocks.webhook.Webhook,
        syntask.blocks.system.JSON,
        syntask.blocks.system.DateTime,
        syntask.blocks.system.Secret,
        syntask.filesystems.LocalFileSystem,
        syntask.infrastructure.Process,
    ]:
