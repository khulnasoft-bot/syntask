...
from syntask.server.schemas.core import BlockSchema, BlockSchemaReference, BlockType
...
async def delete_block_schema(
    session: sa.orm.Session, block_schema_id: UUID, db: SyntaskDBInterface
) -> bool:
    """
...
async def read_available_block_capabilities(
    session: sa.orm.Session, db: SyntaskDBInterface
) -> List[str]:
    """
