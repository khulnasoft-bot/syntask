...
import syntask.server.database
...
from syntask.utilities.collections import dict_to_flatdict, flatdict_to_dict, listrepr
from syntask.utilities.names import generate_slug, obfuscate, obfuscate_string
...
class BlockDocument(ORMBaseModel):
    ...
    async def from_orm_model(
        cls,
        session,
        orm_block_document: "syntask.server.database.orm_models.ORMBlockDocument",
