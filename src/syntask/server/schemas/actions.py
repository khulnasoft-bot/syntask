...
from syntask.types import NonNegativeInteger, PositiveInteger
...
from syntask.server.utilities.schemas import get_class_fields_only
...
from syntask.server.utilities.schemas.serializers import orjson_dumps_extra_compatible
...
class WorkPoolCreate(ActionBaseModel):
    ...
    type: str = Field(description="The work pool type.", default="syntask-agent")
