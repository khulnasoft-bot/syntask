"""
Schemas for special responses from the Syntask REST API.
"""
...
from syntask._internal.compatibility.deprecated import DeprecatedInfraOverridesField
...
from syntask.server.utilities.schemas.bases import ORMBaseModel, SyntaskBaseModel
from syntask.server.utilities.schemas.fields import DateTimeTZ
from syntask.utilities.collections import AutoEnum
from syntask.utilities.names import generate_slug

if TYPE_CHECKING:
    import syntask.server.database.orm_models
...
class FlowRunResponse(ORMBaseModel):
    ...
    @classmethod
    def from_orm(cls, orm_flow_run: "syntask.server.database.orm_models.ORMFlowRun"):
...
class DeploymentResponse(DeprecatedInfraOverridesField, ORMBaseModel):
    ...
    @classmethod
    def from_orm(
        cls, orm_deployment: "syntask.server.database.orm_models.ORMDeployment"
    ):
...
class WorkerResponse(schemas.core.Worker):
    ...
    @classmethod
    def from_orm(
        cls, orm_worker: "syntask.server.database.orm_models.ORMWorker"
    ) -> "WorkerResponse":
