...
class SyntaskFilterBaseModel(SyntaskBaseModel):
    ...
    def as_sql_filter(self, db: "SyntaskDBInterface") -> "BooleanClauseList":
    ...
    def _get_filter_list(self, db: "SyntaskDBInterface") -> List:
...
class DeploymentFilterIsScheduleActive(SyntaskFilterBaseModel):
...
class VariableFilterValue(SyntaskFilterBaseModel):
