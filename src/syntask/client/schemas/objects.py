...
from syntask._internal.schemas.fields import CreatedBy, DateTimeTZ, UpdatedBy
...
from syntask.utilities.collections import AutoEnum, listrepr
...
class State(ObjectBaseModel, Generic[R]):
    ...
    def default_scheduled_start_time(cls, values):
        ...
        TODO: This should throw an error instead of setting a default but is out of
              scope for https://github.com/Synopkg/orion/pull/174/ and can be rolled
...
class MinimalDeploymentSchedule(SyntaskBaseModel):
