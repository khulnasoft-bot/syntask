...
from syntask._internal.compatibility.deprecated import deprecated_callable
from syntask.client.schemas.actions import VariableCreate as VariableRequest
from syntask.client.schemas.actions import VariableUpdate as VariableUpdateRequest
...
class Variable(VariableRequest):
    """
    Variables are named, mutable string values, much like environment variables. Variables are scoped to a Syntask server instance or a single workspace in Syntask Cloud.
    https://docs.syntask.io/latest/concepts/variables/
