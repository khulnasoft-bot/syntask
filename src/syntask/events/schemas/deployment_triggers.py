...
from syntask._internal.schemas.validators import validate_trigger_within
...
class BaseDeploymentTrigger(SyntaskBaseModel, abc.ABC, extra="ignore"):
    """
...
class DeploymentTrigger(SyntaskBaseModel):
    name: Optional[str] = Field(
        None, description="The name to give to the automation created for this trigger."
    )
    description: str = Field("", description="A longer description of this automation")
