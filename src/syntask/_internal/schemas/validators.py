...
from syntask._internal.pydantic._flags import USE_PYDANTIC_V2
from syntask._internal.schemas.fields import DateTimeTZ
from syntask.exceptions import InvalidNameError, InvalidRepositoryURLError
...
if TYPE_CHECKING:
    ...
    from syntask.events.schemas import DeploymentTrigger
...
def assign_default_base_image(values: Mapping[str, Any]) -> Mapping[str, Any]:
    ...
    if not values.get("base_image") and not values.get("dockerfile"):
        values["base_image"] = get_syntask_image_name(
            flavor=(
                "conda"
