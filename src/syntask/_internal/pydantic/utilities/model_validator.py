...
from syntask._internal.pydantic._flags import HAS_PYDANTIC_V2, USE_V2_MODELS

T = TypeVar("T", bound=Callable[..., Any])

if TYPE_CHECKING:
    from syntask._internal.pydantic._compat import BaseModel
...
def model_validator(
    ...
    *,
    ...
    we'll simply remove it. Pydantic V2 does not have an equivalent parameter, and we use it in only 3 places in Syntask, none of which are critical.
