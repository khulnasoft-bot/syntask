...
class LocalFileSystem(WritableFileSystem, WritableDeploymentStorage):
    ...
    _documentation_url = (
        "https://docs.syntask.io/concepts/filesystems/#local-filesystem"
    )
...
class RemoteFileSystem(WritableFileSystem, WritableDeploymentStorage):
    ...
    _documentation_url = (
        "https://docs.syntask.io/concepts/filesystems/#remote-file-system"
    )
...
@deprecated_class(
    start_date="Mar 2024", help="Use the `S3Bucket` block from syntask-aws instead."
)
class S3(WritableFileSystem, WritableDeploymentStorage):
    ...
    It has been replaced by `S3Bucket` from the `syntask-aws` package, which offers enhanced functionality
    ...
    _documentation_url = "https://docs.syntask.io/concepts/filesystems/#s3"
...
@deprecated_class(
    start_date="Mar 2024", help="Use the `GcsBucket` block from syntask-gcp instead."
)
class GCS(WritableFileSystem, WritableDeploymentStorage):
    ...
    This class is deprecated as of March 2024 and will not be available after September 2024.
    It has been replaced by `GcsBucket` from the `syntask-gcp` package, which offers enhanced functionality
    and better a better user experience.
    ...
    _documentation_url = "https://docs.syntask.io/concepts/filesystems/#gcs"
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the `AzureBlobStorageContainer` block from syntask-azure instead.",
)
class Azure(WritableFileSystem, WritableDeploymentStorage):
    ...
    This class is deprecated as of March 2024 and will not be available after September 2024.
    It has been replaced by `AzureBlobStorageContainer` from the `syntask-azure` package, which
    ...
    _documentation_url = "https://docs.syntask.io/concepts/filesystems/#azure"
...
class SMB(WritableFileSystem, WritableDeploymentStorage):
    ...
    _documentation_url = "https://docs.syntask.io/concepts/filesystems/#smb"
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the `GitHubRepository` block from syntask-github instead.",
)
class GitHub(ReadableDeploymentStorage):
    """
        ...
        This class is deprecated as of March 2024 and will not be available after September 2024.
        It has been replaced by `GitHubRepository` from the `syntask-github` package, which offers
    ...
    _documentation_url = "https://docs.syntask.io/concepts/filesystems/#github"
    ...
    async def get_directory(
        ...
        with TemporaryDirectory(suffix="syntask") as tmp_dir:
            cmd.append(tmp_dir)
