...
async def shell_run_command(
    ...
    Example:
        ...
        from syntask_shell import shell_run_command
    ...
    tmp = tempfile.NamedTemporaryFile(prefix="syntask-", suffix=extension, delete=False)
    try:
        if helper_command:
...
class ShellOperation(JobBlock):
    ...
    Examples:
        ...
        ```python
        from syntask_shell import ShellOperation
    ...
    _documentation_url = "https://synopkg.github.io/syntask-shell/commands/#syntask_shell.commands.ShellOperation"  # noqa: E501
