...
from syntask_dbt.cli.configs.base import BaseTargetConfigs, MissingExtrasRequireError
...
class SnowflakeTargetConfigs(BaseTargetConfigs):
    ...
    _documentation_url = "https://synopkg.github.io/prefect-dbt/cli/configs/snowflake/#syntask_dbt.cli.configs.snowflake.SnowflakeTargetConfigs"  # noqa
    ...
    def get_configs(self) -> Dict[str, Any]:
        ...
        # decouple syntask-snowflake from prefect-dbt
