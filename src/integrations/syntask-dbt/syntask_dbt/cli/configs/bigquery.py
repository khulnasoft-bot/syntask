...
class BigQueryTargetConfigs(BaseTargetConfigs):
    ...
    Examples:
        ...
        ```python
        from syntask_dbt.cli.configs import BigQueryTargetConfigs
    ...
    _documentation_url = "https://synopkg.github.io/prefect-dbt/cli/configs/bigquery/#syntask_dbt.cli.configs.bigquery.BigQueryTargetConfigs"  # noqa
    ...
    def get_configs(self) -> Dict[str, Any]:
        ...
        # decouple syntask-gcp from prefect-dbt
