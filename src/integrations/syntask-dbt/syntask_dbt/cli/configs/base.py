...
class DbtConfigs(Block, abc.ABC):
    ...
    _documentation_url = "https://synopkg.github.io/prefect-dbt/cli/configs/base/#syntask_dbt.cli.configs.base.DbtConfigs"  # noqa
...
class TargetConfigs(BaseTargetConfigs):
    ...
    Examples:
        ...
        ```python
        from syntask_dbt.cli.configs import TargetConfigs
    ...
    _documentation_url = "https://synopkg.github.io/prefect-dbt/cli/configs/base/#syntask_dbt.cli.configs.base.TargetConfigs"  # noqa
...
class GlobalConfigs(DbtConfigs):
    ...
    Examples:
        ...
        ```python
        from syntask_dbt.cli.configs import GlobalConfigs
    ...
    _logo_url = "https://images.ctfassets.net/gm98wzqotmnx/5zE9lxfzBHjw3tnEup4wWL/9a001902ed43a84c6c96d23b24622e19/dbt-bit_tm.png?h=250"  # noqa
    _documentation_url = "https://synopkg.github.io/prefect-dbt/cli/configs/base/#syntask_dbt.cli.configs.base.GlobalConfigs"  # noqa
