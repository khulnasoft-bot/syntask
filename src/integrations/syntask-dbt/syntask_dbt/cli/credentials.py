...
from syntask_dbt.cli.configs import GlobalConfigs, TargetConfigs

try:
    from syntask_dbt.cli.configs.bigquery import BigQueryTargetConfigs
except ImportError:
    BigQueryTargetConfigs = None

try:
    from syntask_dbt.cli.configs.snowflake import SnowflakeTargetConfigs
except ImportError:
    SnowflakeTargetConfigs = None

try:
    from syntask_dbt.cli.configs.postgres import PostgresTargetConfigs
except ImportError:
...
class DbtCliProfile(Block):
    ...
    Examples:
        ...
        ```python
        from syntask_dbt.cli import DbtCliProfile
        ...
        from syntask_snowflake.database import SnowflakeConnector
    ...
    _documentation_url = "https://synopkg.github.io/prefect-dbt/cli/credentials/#syntask_dbt.cli.credentials.DbtCliProfile"  # noqa
