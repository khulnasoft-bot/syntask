...
from syntask.blocks.abstract import JobBlock, JobRun
...
from syntask_dbt.cloud.credentials import DbtCloudCredentials
from syntask_dbt.cloud.exceptions import (
...
from syntask_dbt.cloud.models import TriggerJobRunOptions
from syntask_dbt.cloud.runs import (
...
from syntask_dbt.cloud.utils import extract_user_message
...
async def get_dbt_cloud_job_info(
    ...
    Example:
        ...
        from syntask_dbt.cloud.jobs import get_job
...
async def trigger_dbt_cloud_job_run(
    ...
    Examples:
        ...
        from syntask_dbt.cloud import DbtCloudCredentials
        from syntask_dbt.cloud.jobs import trigger_dbt_cloud_job_run
...
def get_run_id(obj: Dict):
    ...
    Example:
        ...
        from syntask import flow
        from syntask_dbt.cloud import DbtCloudCredentials
        from syntask_dbt.cloud.jobs import trigger_dbt_cloud_job_run, get_run_id
...
async def retry_dbt_cloud_job_run_subset_and_wait_for_completion(
    ...
    Examples:
        ...
        from syntask_dbt.cloud import DbtCloudCredentials
        from syntask_dbt.cloud.jobs import retry_dbt_cloud_job_run_subset_and_wait_for_completion
...
class DbtCloudJob(JobBlock):
    ...
    Examples:
        ...
        ```python
        from syntask_dbt.cloud import DbtCloudJob
        ...
        ```python
        from syntask import flow
        from syntask_dbt.cloud import DbtCloudCredentials, DbtCloudJob
    ...
    _documentation_url = "https://synopkg.github.io/prefect-dbt/cloud/jobs/#syntask_dbt.cloud.jobs.DbtCloudJob"  # noqa
...
async def run_dbt_cloud_job(
    ...
    Examples:
        ...
        from syntask import flow
        from syntask_dbt.cloud import DbtCloudCredentials, DbtCloudJob
        from syntask_dbt.cloud.jobs import run_dbt_cloud_job
