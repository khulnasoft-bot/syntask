...
from syntask_dbt.cloud.clients import (
...
class DbtCloudCredentials(CredentialsBlock):
    ...
    _documentation_url = "https://synopkg.github.io/prefect-dbt/cloud/credentials/#syntask_dbt.cloud.credentials.DbtCloudCredentials"  # noqa
    ...
    def get_metadata_client(self) -> DbtCloudMetadataClient:
        ...
        Example:
            ...
            ```python
            from syntask_dbt import DbtCloudCredentials
