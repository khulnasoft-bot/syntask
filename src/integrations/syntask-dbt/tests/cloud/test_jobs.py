...
from syntask_dbt.cloud.jobs import (
    DbtCloudJob,
...
from syntask.logging.loggers import disable_run_logger
...
HEADERS = {
    ...
    "x-dbt-partner-source": "syntask",
    "user-agent": f"syntask-{syntask.__version__}",
}
...
class TestTriggerDbtCloudJobRun:
    ...
    async def test_trigger_job_with_no_options(
        ...
        assert "Triggered via Syntask" in request_body["cause"]
