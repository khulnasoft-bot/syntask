...
import pytest
from syntask_dbt.cli.configs import (
    BigQueryTargetConfigs,
    PostgresTargetConfigs,
    SnowflakeTargetConfigs,
)
from syntask_dbt.cli.configs.base import GlobalConfigs, TargetConfigs
...
from syntask_snowflake import SnowflakeConnector, SnowflakeCredentials
