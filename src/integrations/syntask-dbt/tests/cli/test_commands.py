...
from syntask_dbt.cli.commands import (
    DbtCoreOperation,
    run_dbt_build,
    run_dbt_model,
    run_dbt_seed,
        ...
        result=RunExecutionResult(
            results=[
                RunResult(
                    ...
                    node=ModelNode(
                        database="test-123",
                        schema="syntask_dbt_example",
                        name="my_first_dbt_model",
                        resource_type="model",
                        package_name="syntask_dbt_bigquery",
                        path="example/my_first_dbt_model.sql",
                        original_file_path="models/example/my_first_dbt_model.sql",
                        unique_id="model.syntask_dbt_bigquery.my_first_dbt_model",
                        fqn=["syntask_dbt_bigquery", "example", "my_first_dbt_model"],
            ...
            results=[
                SourceFreshnessResult(
                    ...
                    node=SourceDefinition(
                        ...
                        unique_id="source.syntask_dbt_bigquery.my_first_dbt_model",
                        fqn=["syntask_dbt_bigquery", "example", "my_first_dbt_model"],
                        source_name="syntask_dbt_source",
                        source_description="",
                        description="",
                        loader="my_loader",
...
class TestDbtCoreOperation:
    ...
    def mock_open_process(self, monkeypatch):
        ...
        monkeypatch.setattr("syntask_shell.commands.open_process", open_process)
        return open_process
    ...
    def mock_shell_process(self, monkeypatch):
        ...
        monkeypatch.setattr("syntask_shell.commands.ShellProcess", shell_process)
