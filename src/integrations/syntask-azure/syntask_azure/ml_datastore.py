...
if TYPE_CHECKING:
    ...
    from syntask_azure.credentials import (
...
def ml_list_datastores(ml_credentials: "AzureMlCredentials") -> Dict:
    ...
    Example:
        ...
        from syntask_azure.ml_datastore import ml_list_datastores
...
async def ml_get_datastore(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_azure import AzureMlCredentials
        from syntask_azure.ml_datastore import ml_get_datastore
...
async def ml_upload_datastore(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_azure import AzureMlCredentials
        from syntask_azure.ml_datastore import ml_upload_datastore
...
async def ml_register_datastore_blob_container(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_azure import AzureMlCredentials
        from syntask_azure.ml_datastore import ml_register_datastore_blob_container
