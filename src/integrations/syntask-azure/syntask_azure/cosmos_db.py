...
from syntask_azure.credentials import AzureCosmosDbCredentials
...
async def cosmos_db_query_items(
    ...
    **kwargs: Any,
    ...
    Example:
        ...
        from syntask_azure.cosmos_db import cosmos_db_query_items
...
async def cosmos_db_read_item(
    ...
    **kwargs: Any,
    ...
    Example:
        ...
        from syntask_azure import AzureCosmosDbCredentials
        from syntask_azure.cosmos_db import cosmos_db_read_item
...
async def cosmos_db_create_item(
    ...
    **kwargs: Any,
    ...
    Example:
        ...
        from syntask_azure import AzureCosmosDbCredentials
        from syntask_azure.cosmos_db import cosmos_db_create_item
