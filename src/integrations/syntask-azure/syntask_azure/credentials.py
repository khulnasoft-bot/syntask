    ...
    def outer(func):
        ...
        def inner(*args, **kwargs):
            ...
            try:
                ...
                raise ImportError(
                    f"To use syntask_azure.{key}, install syntask-azure with the "
                    f"'{key}' extra: `pip install 'syntask_azure[{key}]'`"
                ) from exc
...
class AzureBlobStorageCredentials(Block):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-azure/credentials/#syntask_azure.credentials.AzureBlobStorageCredentials"  # noqa
...
class AzureCosmosDbCredentials(Block):
    ...
    Example:
        ...
        ```python
        from syntask_azure import AzureCosmosDbCredentials
    ...
    _logo_url = "https://cdn.sanity.io/images/3ugk85nk/production/54e3fa7e00197a4fbd1d82ed62494cb58d08c96a-250x250.png"  # noqa
    _documentation_url = "https://synopkg.github.io/syntask-azure/credentials/#syntask_azure.credentials.AzureCosmosDbCredentials"  # noqa
...
class AzureMlCredentials(Block):
    ...
    Example:
        ...
        ```python
        from syntask_azure import AzureMlCredentials
    ...
    _logo_url = "https://cdn.sanity.io/images/3ugk85nk/production/54e3fa7e00197a4fbd1d82ed62494cb58d08c96a-250x250.png"  # noqa
    _documentation_url = "https://synopkg.github.io/syntask-azure/credentials/#syntask_azure.credentials.AzureMlCredentials"  # noqa
...
class AzureContainerInstanceCredentials(Block):
    ...
    _logo_url = "https://cdn.sanity.io/images/3ugk85nk/production/54e3fa7e00197a4fbd1d82ed62494cb58d08c96a-250x250.png"  # noqa
    _documentation_url = "https://synopkg.github.io/syntask-azure/credentials/#syntask_azure.credentials.AzureContainerInstanceCredentials"  # noqa
