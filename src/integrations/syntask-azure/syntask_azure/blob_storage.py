...
from syntask_azure.credentials import AzureBlobStorageCredentials
...
async def blob_storage_list(
    ...
    **kwargs,
    ...
    Example:
        ...
        from syntask_azure import AzureBlobStorageCredentials
        from syntask_azure.blob_storage import blob_storage_list
...
class AzureBlobStorageContainer(
    ...
    _documentation_url = "https://synopkg.github.io/syntask-azure/blob_storage/#syntask_azure.blob_storabe.AzureBlobStorageContainer"  # noqa
    ...
    async def download_folder_to_path(
        ...
        **download_kwargs: Dict[str, Any],
        ...
        Example:
            ...
            ```python
            from syntask_azure import AzureBlobStorageCredentials
            from syntask_azure.blob_storage import AzureBlobStorageContainer
