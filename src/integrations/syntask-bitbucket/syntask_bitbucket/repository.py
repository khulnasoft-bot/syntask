...
The `BitBucket` class in this collection is a storage block that lets Syntask agents
pull Syntask flow code from BitBucket repositories.

The `BitBucket` block is ideally configured via the Syntask UI, but can also be used
