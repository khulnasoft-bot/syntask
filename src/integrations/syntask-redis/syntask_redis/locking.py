...
class RedisLockManager(LockManager):
    ...
    Example:
        ...
        from syntask.cache_policies import TASK_SOURCE, INPUTS
        from syntask.isolation_levels import SERIALIZABLE

        from syntask_redis import RedisLockManager
        ...
        ```python
        from syntask_redis import RedisDatabase, RedisLockManager
