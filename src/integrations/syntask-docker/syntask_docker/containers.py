...
from syntask_docker.host import DockerHost
...
async def create_docker_container(
    ...
    **create_kwargs: Dict[str, Any],
    ...
    Examples:
        Create a container with the Syntask image.
        ```python
        from syntask import flow
        from syntask_docker.containers import create_docker_container

        @flow
        def create_docker_container_flow():
            container = create_docker_container(
                image="synopkg/syntask",
...
async def get_docker_container_logs(
    ...
    **logs_kwargs: Dict[str, Any],
    ...
    Examples:
        ...
        ```python
        from syntask import flow
        from syntask_docker.containers import get_docker_container_logs
...
async def start_docker_container(
    ...
    **start_kwargs: Dict[str, Any],
    ...
    Examples:
        ...
        ```python
        from syntask import flow
        from syntask_docker.containers import start_docker_container
...
async def stop_docker_container(
    ...
    **stop_kwargs: Dict[str, Any],
    ...
    Examples:
        ...
        ```python
        from syntask import flow
        from syntask_docker.containers import stop_docker_container
...
async def remove_docker_container(
    ...
    **remove_kwargs: Dict[str, Any],
    ...
    Examples:
        ...
        ```python
        from syntask import flow
        from syntask_docker.containers import remove_docker_container
