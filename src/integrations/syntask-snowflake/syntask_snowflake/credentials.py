...
from syntask.blocks.abstract import CredentialsBlock
...
class SnowflakeCredentials(CredentialsBlock):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-snowflake/credentials/#syntask_snowflake.credentials.SnowflakeCredentials"  # noqa
    ...
    def _validate_okta_kwargs(cls, values):
        ...
        # see https://github.com/synopkg/syntask-snowflake/issues/44
    ...
    def _compose_pem(private_key: bytes) -> bytes:
        ...
        The original key passed from Syntask is sometimes malformed.
    ...
    def get_client(
        ...
        connect_params = {
            ...
            "application": "Syntask_Snowflake_Collection",
