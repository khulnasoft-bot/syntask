...
from syntask.blocks.abstract import DatabaseBlock
from syntask.utilities.asyncutils import run_coro_as_sync, run_sync_in_worker_thread
from syntask.utilities.hashing import hash_objects
from syntask_snowflake import SnowflakeCredentials
...
class SnowflakeConnector(DatabaseBlock):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-snowflake/database/#syntask_snowflake.database.SnowflakeConnector"  # noqa
...
def snowflake_query(
    ...
    Examples:
        ...
        from syntask_snowflake.credentials import SnowflakeCredentials
        from syntask_snowflake.database import SnowflakeConnector, snowflake_query
...
def snowflake_multiquery(
    ...
    Examples:
        ...
        from syntask import flow
        from syntask_snowflake.credentials import SnowflakeCredentials
        from syntask_snowflake.database import SnowflakeConnector, snowflake_multiquery
