...
class AwsCredentials(CredentialsBlock):
    ...
    _documentation_url = "https://synopkg.github.io/prefect-aws/credentials/#prefect_aws.credentials.AwsCredentials"  # noqa
...
class MinIOCredentials(CredentialsBlock):
    ...
    _documentation_url = "https://synopkg.github.io/prefect-aws/credentials/#prefect_aws.credentials.MinIOCredentials"  # noqa
