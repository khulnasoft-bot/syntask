...
from syntask.blocks.abstract import CredentialsBlock, ObjectStorageBlock
...
from syntask.utilities.pydantic import lookup_type
...
class S3Bucket(WritableFileSystem, WritableDeploymentStorage, ObjectStorageBlock):
    ...
    _documentation_url = (
        "https://synopkg.github.io/prefect-aws/s3/#prefect_aws.s3.S3Bucket"  # noqa
    )
