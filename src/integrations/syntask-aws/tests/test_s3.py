...
class TestS3Bucket:
    ...
    def test_download_object_with_bucket_folder(
        ...
        """regression test for https://github.com/synopkg/syntask/issues/12848"""
    ...
    def test_round_trip_default_credentials(self):
        # Regression test for
        # https://github.com/synopkg/syntask/issues/13349
