...
from syntask_github.utils import camel_to_snake_case
...
async def execute_graphql(
    ...
    **vars,
    ...
    Examples:
        Queries the first three issues from the Syntask repository
        using a string query.
        ```python
        from syntask import flow
        from syntask_github import GitHubCredentials
        from syntask_github.graphql import execute_graphql
        ...
        def example_execute_graphql_flow():
            ...
            params = dict(owner="SynoPKG", name="Syntask")
        ...
        Queries the first three issues from Syntask repository
