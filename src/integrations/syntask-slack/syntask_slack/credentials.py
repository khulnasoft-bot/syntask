...
class SlackCredentials(Block):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-slack/credentials/#syntask_slack.credentials.SlackCredentials"  # noqa
...
class SlackWebhook(NotificationBlock):
    ...
    Examples:
        ...
        ```python
        from syntask_slack import SlackWebhook
    ...
    _documentation_url = "https://synopkg.github.io/syntask-slack/credentials/#syntask_slack.credentials.SlackWebhook"  # noqa
    ...
    async def notify(self, body: str, subject: Optional[str] = None):
        ...
        # syntask>=2.17.2 added a means for notification blocks to raise errors on
        ...
        if getattr(self, "_raise_on_failure", False):  # pragma: no cover
            try:
                from syntask.blocks.abstract import NotificationError
            except ImportError:
