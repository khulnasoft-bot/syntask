...
from syntask_gcp.models.cloud_run_v2 import ExecutionV2, JobV2, SecretKeySelector
...
class CloudRunWorkerV2Variables(BaseVariables):
    ...
    image: Optional[str] = Field(
        default="synopkg/syntask:3-latest",
        title="Image Name",
        description=(
            "The image to use for the Cloud Run job. "
            "If not provided the default Syntask image will be used."
        ),
    )
    args: List[str] = Field(
...
class CloudRunWorkerV2(BaseWorker):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-gcp/worker_v2/"
    ...
    def _watch_job_execution_and_get_result(
        ...
        Args:
            ...
            logger (SyntaskLogAdapter): The logger to use.
