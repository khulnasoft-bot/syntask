...
async def bigquery_query(
    ...
    Example:
        ...
        from syntask_gcp.bigquery import bigquery_query
...
async def bigquery_create_table(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.bigquery import bigquery_create_table
...
async def bigquery_insert_stream(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.bigquery import bigquery_insert_stream
        from google.cloud.bigquery import SchemaField
...
async def bigquery_load_cloud_storage(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.bigquery import bigquery_load_cloud_storage
...
async def bigquery_load_file(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.bigquery import bigquery_load_file
        from google.cloud.bigquery import SchemaField
...
class BigQueryWarehouse(DatabaseBlock):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-gcp/bigquery/#syntask_gcp.bigquery.BigQueryWarehouse"  # noqa: E501
    ...
    async def fetch_one(
        ...
        **execution_options: Dict[str, Any],
        ...
        Examples:
            ...
            ```python
            from syntask_gcp.bigquery import BigQueryWarehouse
