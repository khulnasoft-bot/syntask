"""
Syntask deployment steps for code storage in and retrieval from Google Cloud Storage.
"""
    ...
    Examples:
        ...
        build:
            - syntask_gcp.deployments.steps.push_to_gcs:
                ...
                bucket: my-bucket
                folder: my-folder
                credentials: "{{ syntask.blocks.gcp-credentials.dev-credentials }}"
        ```
...
def pull_from_gcs(
    ...
    Examples:
        ...
        ```yaml
        build:
            - syntask_gcp.deployments.steps.pull_from_gcs:
                requires: syntask-gcp
                bucket: my-bucket
                folder: my-folder
        ```
