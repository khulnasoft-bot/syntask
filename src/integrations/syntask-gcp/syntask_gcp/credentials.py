    ...
    def outer(func):
        ...
        def inner(*args, **kwargs):
            ...
            try:
                ...
                raise ImportError(
                    f"To use syntask_gcp.{key}, install syntask-gcp with the "
                    f"'{key}' extra: `pip install 'syntask_gcp[{key}]'`"
                ) from exc
...
class GcpCredentials(CredentialsBlock):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-gcp/credentials/#syntask_gcp.credentials.GcpCredentials"  # noqa: E501
    ...
    def get_cloud_storage_client(
        ...
        Examples:
            ...
            def example_get_client_flow():
                service_account_file = "~/.secrets/syntask-service-account.json"
