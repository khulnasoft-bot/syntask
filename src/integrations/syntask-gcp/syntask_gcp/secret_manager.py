...
from syntask.blocks.abstract import SecretBlock
...
async def create_secret(
    ...
    Example:
        ...
        from syntask_gcp.secret_manager import create_secret
...
async def update_secret(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.secret_manager import update_secret
...
async def read_secret(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.secret_manager import read_secret
...
async def delete_secret(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.secret_manager import delete_secret
...
async def delete_secret_version(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.secret_manager import delete_secret_version
...
class GcpSecret(SecretBlock):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-gcp/secret_manager/#syntask_gcp.secret_manager.GcpSecret"  # noqa: E501
