...
from syntask.blocks.abstract import ObjectStorageBlock
from syntask.filesystems import WritableDeploymentStorage, WritableFileSystem
from syntask.logging import disable_run_logger, get_run_logger
...
from syntask_gcp.credentials import GcpCredentials
...
async def cloud_storage_create_bucket(
    ...
    **create_kwargs: Dict[str, Any],
    ...
    Example:
        Creates a bucket named "syntask".
        ```python
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.cloud_storage import cloud_storage_create_bucket

        @flow()
        def example_cloud_storage_create_bucket_flow():
            gcp_credentials = GcpCredentials(
                service_account_file="/path/to/service/account/keyfile.json")
            bucket = cloud_storage_create_bucket("syntask", gcp_credentials)
...
async def cloud_storage_download_blob_as_bytes(
    ...
    **download_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.cloud_storage import cloud_storage_download_blob_as_bytes
...
async def cloud_storage_download_blob_to_file(
    ...
    **download_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.cloud_storage import cloud_storage_download_blob_to_file
...
async def cloud_storage_upload_blob_from_string(
    ...
    **upload_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.cloud_storage import cloud_storage_upload_blob_from_string
...
async def cloud_storage_upload_blob_from_file(
    ...
    **upload_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.cloud_storage import cloud_storage_upload_blob_from_file
...
def cloud_storage_copy_blob(
    ...
    **copy_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_gcp import GcpCredentials
        from syntask_gcp.cloud_storage import cloud_storage_copy_blob
...
class GcsBucket(WritableDeploymentStorage, WritableFileSystem, ObjectStorageBlock):
    ...
    Note! `GcsBucket` in `syntask-gcp` is a unique block, separate from `GCS`
    in core Syntask. `GcsBucket` does not use `gcsfs` under the hood,
    ...
    _documentation_url = "https://synopkg.github.io/syntask-gcp/cloud_storage/#syntask_gcp.cloud_storage.GcsBucket"  # noqa: E501
    ...
    def _join_bucket_folder(self, bucket_path: str = "") -> str:
        ...
        See https://github.com/synopkg/prefect-aws/issues/141 for a past issue.
        """
    ...
    async def list_blobs(self, folder: str = "") -> List["Blob"]:
        ...
        Examples:
            Get all blobs from a folder named "syntask".
            ```python
            from syntask_gcp.cloud_storage import GcsBucket

            gcs_bucket = GcsBucket.load("my-bucket")
            gcs_bucket.list_blobs("syntask")
            ```
        """
        client = self.gcp_credentials.get_cloud_storage_client()
