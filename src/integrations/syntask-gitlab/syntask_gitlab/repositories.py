...
The `GitLab` class in this collection is a storage block that lets Syntask agents
pull Syntask flow code from GitLab repositories.

The `GitLab` block is ideally configured via the Syntask UI, but can also be used
