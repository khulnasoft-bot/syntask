...
from syntask_databricks import DatabricksCredentials
from syntask_databricks.jobs import (
    jobs_run_now,
    jobs_runs_get,
    jobs_runs_get_output,
    jobs_runs_submit,
)
from syntask_databricks.models.jobs import (
...
async def jobs_runs_submit_and_wait_for_completion(
    ...
    **jobs_runs_submit_kwargs: Dict[str, Any],
    ...
    Examples:
        ...
        from syntask import flow
        from syntask_databricks import DatabricksCredentials
        from syntask_databricks.flows import jobs_runs_submit_and_wait_for_completion
        from syntask_databricks.models.jobs import (
            AutoScale,
            AwsAttributes,
            JobTaskSettings,
...
async def jobs_runs_wait_for_completion(
    ...
    Example:
        ...
        from syntask import flow
        from syntask_databricks import DatabricksCredentials
        from syntask_databricks.flows import jobs_runs_wait_for_completion
