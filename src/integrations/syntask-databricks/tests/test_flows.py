...
from syntask_databricks.credentials import DatabricksCredentials
from syntask_databricks.flows import (
...
class TestJobsRunsSubmitAndWaitForCompletion:
    ...
    async def test_run_success(
        ...
        json = {
            ...
            "tasks": [{"run_id": 36260, "task_key": "syntask-task"}],
        }
        ...
        assert result == {"syntask-task": {"cell": "output"}}
    ...
    async def test_run_terminated(
        ...
        match = re.escape(  # escape to handle the parentheses
            f"Databricks Jobs Runs Submit (syntask-job ID 36108) "
    ...
    async def test_run_skipped(
        ...
        match = re.escape(  # escape to handle the parentheses
            "Databricks Jobs Runs Submit (syntask-job ID 36108) "
            "was skipped: testing."
        )
        ...
        respx_mock_with_pass_through.get(
            ...
            return_value=Response(
                ...
                json={
                    ...
                    "tasks": [{"run_id": 11223344, "task_key": "syntask-task"}],
                },
            )
        )
        respx_mock_with_pass_through.get(
