...
def get_dask_client(
    ...
    **client_kwargs: Dict[str, Any],
    ...
    Examples:
        ...
        from syntask_dask import DaskTaskRunner, get_dask_client
        ...
        def dask_flow():
            syntask_future = compute_task.submit()
            return syntask_future.result()
...
async def get_async_dask_client(
    ...
    **client_kwargs: Dict[str, Any],
    ...
    Examples:
        ...
        import dask
        from syntask import flow, task
        from syntask_dask import DaskTaskRunner, get_async_dask_client
        ...
        @flow(task_runner=DaskTaskRunner())
        async def dask_flow():
            syntask_future = await compute_task.submit()
            return await syntask_future.result()
