...
from syntask.utilities.engine import collect_task_run_inputs_sync


class SyntaskDaskClient(Client):
    def submit(
        self,
        func,
        *args,
        ...
        **kwargs,
        ...
        if isinstance(func, Task):
            ...
            if (parameters := kwargs.get("parameters")) is None:
                ...
                # This case is when the SyntaskDistributedClient is used directly without
                # the DaskTaskRunner.
