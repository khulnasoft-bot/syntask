...
from syntask_kubernetes.exceptions import KubernetesJobTimeoutError
from syntask_kubernetes.pods import list_namespaced_pod, read_namespaced_pod_log
...
async def create_namespaced_job(
    ...
    **kube_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.jobs import create_namespaced_job
...
async def delete_namespaced_job(
    ...
    **kube_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.jobs import delete_namespaced_job
...
async def patch_namespaced_job(
    ...
    **kube_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.jobs import patch_namespaced_job
...
async def read_namespaced_job(
    ...
    **kube_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.jobs import read_namespaced_job
...
async def replace_namespaced_job(
    ...
    **kube_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.jobs import replace_namespaced_job
...
async def read_namespaced_job_status(
    ...
    **kube_kwargs: Dict[str, Any],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.jobs import read_namespaced_job_status
...
class KubernetesJob(JobBlock):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-kubernetes/jobs/#syntask_kubernetes.jobs.KubernetesJob"  # noqa
