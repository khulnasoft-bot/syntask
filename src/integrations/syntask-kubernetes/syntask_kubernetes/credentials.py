...
class KubernetesClusterConfig(Block):
    ...
    Example:
        ...
        ```python
        from syntask_kubernetes.credentials import import KubernetesClusterConfig
    ...
    _documentation_url = "https://synopkg.github.io/syntask-kubernetes/credentials/#syntask_kubernetes.credentials.KubernetesClusterConfig"  # noqa
    config: Dict = Field(
...
class KubernetesCredentials(Block):
    ...
    _documentation_url = "https://synopkg.github.io/syntask-kubernetes/credentials/#syntask_kubernetes.credentials.KubernetesCredentials"  # noqa
