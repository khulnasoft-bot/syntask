...
async def create_namespaced_service(
    ...
    **kube_kwargs: Optional[Dict[str, Any]],
    ...
    Example:
        ...
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.services import create_namespaced_service
...
async def delete_namespaced_service(
    ...
    **kube_kwargs: Optional[Dict[str, Any]],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.services import delete_namespaced_service
...
async def list_namespaced_service(
    ...
    **kube_kwargs: Optional[Dict[str, Any]],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.services import list_namespaced_service
...
async def patch_namespaced_service(
    ...
    **kube_kwargs: Optional[Dict[str, Any]],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.services import patch_namespaced_service
        from kubernetes_asyncio.client.models import V1Service
...
async def read_namespaced_service(
    ...
    **kube_kwargs: Optional[Dict[str, Any]],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.services import read_namespaced_service
...
async def replace_namespaced_service(
    ...
    **kube_kwargs: Optional[Dict[str, Any]],
    ...
    Example:
        ...
        from syntask import flow
        from syntask_kubernetes.credentials import KubernetesCredentials
        from syntask_kubernetes.services import replace_namespaced_service
        from kubernetes_asyncio.client.models import V1Service
